...
function CreateOrder() {
  ...
  const priorityPrice = withPriority ? totalCartPrice + priorityFee : 0;
      ...
      <Form method="POST" action="">
        ...
        <div className="mb-12 flex items-center gap-5">
          <input
            ...
            focus:outline-none focus:ring focus:ring-teal-500 focus:ring-offset-0"
            type="checkbox"
            name="priority"
            id="priority"
            value={withPriority}
